...
const Register = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      toast.success(
        `Welcome to SCATCH, ${user?.name?.split(' ')[0] || 'User'}!`
      )
    ...
    <div className="min-h-screen bg-primary flex">
      ...
      <div ref={imageRef} className="hidden lg:block w-1/2 relative">
        <div
          ...
          style={{
            backgroundImage:
              'url(https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=1200)',
          }}
        />
            ...
            >
              ...
              >
                <svg width="18" height="18" viewBox="0 0 18 18">
                  ...
                  <path fill="#EA4335" d="M8.98 4.18c1.17 0 2.23.4 3.06 1.2l2.3-2.3A8 8 0 0 0 1.83 5.4L4.5 7.49a4.77 4.8 0 0 1 4.48-3.3z"/>
                </svg>
